...
const Description = () => (
  <div id="tech-radar">
    <div className="description__info__text section__margin" id="wgpt3">
      <div className="description__info__text-feature"></div>
      <div className="description__info__text-heading"><h1 className="gradient__text">What is the Tech Radar?</h1></div>
      <div className="description__info__text-container">
